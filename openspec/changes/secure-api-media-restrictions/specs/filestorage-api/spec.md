...
L'API SHALL exposer un endpoint permettant d'uploader un seul fichier vers un filesystem nommé. Seuls les fichiers dont le type est autorisé (audio, vidéo, image) et dont la taille n'excède pas la limite configurée sont acceptés.
